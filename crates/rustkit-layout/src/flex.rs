...
mod tests {
    ...
    // ---------------------------------------------------------------
    // css-flexbox-1 §4.1 — the static position of an out-of-flow child
    // of a flex container.
    //
    // Every expected number below was MEASURED in Chrome 148 (the bundled
    // Chromium, 2026-09-19) on a 14-shape probe page before a line of the
    // fix was written, not derived from the spec text. The shape is a
    // 400x200 flex container holding one 60x30 in-flow item and one 50x20
    // out-of-flow child.
    // ---------------------------------------------------------------
